...
var AccessoriesComponent = /** @class */ (function () {
    ...
    AccessoriesComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/accessories/1 (" + index + ").jpg";
        }
    };
    AccessoriesComponent.prototype.preload = function () {
...
var CandlesComponent = /** @class */ (function () {
    function CandlesComponent() {
        this.categoryName = 'candels';
        this.displayName = 'נרות';
        this.numOfPics = 13;
        this.images = new Array();
        this.data = new Array();
    }
    CandlesComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/" + this.categoryName + "/1 (" + index + ").jpg";
        }
    };
    CandlesComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var ClocksComponent = /** @class */ (function () {
    ...
    ClocksComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/" + this.categoryName + "/1 (" + index + ").jpg";
        }
    };
    ClocksComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var FornituresComponent = /** @class */ (function () {
    function FornituresComponent() {
        this.numOfPics = 27;
        this.images = new Array();
        this.data = new Array();
    }
    FornituresComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/fornitures/1 (" + index + ").jpg";
        }
    };
    FornituresComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var GiftpacksComponent = /** @class */ (function () {
    ...
    GiftpacksComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/" + this.categoryName + "/1 (" + index + ").jpg";
        }
    };
    GiftpacksComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var GlassesComponent = /** @class */ (function () {
    ...
    GlassesComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/" + this.categoryName + "/1 (" + index + ").jpg";
        }
    };
    GlassesComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var HangingComponent = /** @class */ (function () {
    ...
    HangingComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/" + this.categoryName + "/1 (" + index + ").jpg";
        }
    };
    HangingComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var MirrorsComponent = /** @class */ (function () {
    ...
    MirrorsComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/" + this.categoryName + "/1 (" + index + ").jpg";
        }
    };
    MirrorsComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var PillowsComponent = /** @class */ (function () {
    ...
    PillowsComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/" + this.categoryName + "/1 (" + index + ").jpg";
        }
    };
    PillowsComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
...
var PlantsComponent = /** @class */ (function () {
    ...
    PlantsComponent.prototype.generateData = function () {
        for (var index = 1; index < this.numOfPics; index++) {
            this.data[index] = "assets/plants/1 (" + index + ").jpg";
        }
    };
    PlantsComponent.prototype.preload = function () {
        for (var i = 0; i < this.data.length; i++) {
            this.images[i] = new Image();
            this.images[i].src = this.data[i + 1];
        }
